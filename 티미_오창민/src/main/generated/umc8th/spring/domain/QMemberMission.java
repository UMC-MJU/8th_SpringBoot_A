...
public class QMemberMission extends EntityPathBase<MemberMission> {
    ...
    private static final long serialVersionUID = -516499812L;
    ...
    public final EnumPath<umc8th.spring.domain.enums.MissionStatus> status = createEnum("status", umc8th.spring.domain.enums.MissionStatus.class);
