...
public class QMember extends EntityPathBase<Member> {
    ...
    private static final long serialVersionUID = 123058384L;

    public static final QMember member = new QMember("member1");

    public final umc8th.spring.domain.enums.QBaseEntity _super = new umc8th.spring.domain.enums.QBaseEntity(this);
    ...
    public final EnumPath<umc8th.spring.domain.enums.Gender> gender = createEnum("gender", umc8th.spring.domain.enums.Gender.class);
    ...
    public final EnumPath<umc8th.spring.domain.enums.SocialType> socialType = createEnum("socialType", umc8th.spring.domain.enums.SocialType.class);

    public final StringPath specAddress = createString("specAddress");

    public final EnumPath<umc8th.spring.domain.enums.MemberStatus> status = createEnum("status", umc8th.spring.domain.enums.MemberStatus.class);
