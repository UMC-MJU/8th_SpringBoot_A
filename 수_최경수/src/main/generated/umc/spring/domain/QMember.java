...
public class QMember extends EntityPathBase<Member> {
    ...
    public final ListPath<umc.spring.domain.alaram.Alarm, umc.spring.domain.alaram.QAlarm> alarmList = this.<umc.spring.domain.alaram.Alarm, umc.spring.domain.alaram.QAlarm>createList("alarmList", umc.spring.domain.alaram.Alarm.class, umc.spring.domain.alaram.QAlarm.class, PathInits.DIRECT2);
